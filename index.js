function gototrending(){
    let btn=document.getElementById("mosttreandingbtn");
    btn.style.color="white";
    btn.style.backgroundColor="black"
    let btn1=document.getElementById("newdropsbtn");
btn1.style.color="black";
btn1.style.backgroundColor="white"

    let drops =document.getElementById("product_sec1");
    drops.style.display="none";
    let trending=document.getElementById("product_sec2");
    trending.style.display="block";
}
function gotodrops(){
let btn=document.getElementById("newdropsbtn");
btn.style.color="white";
btn.style.backgroundColor="black"
let btn1=document.getElementById("mosttreandingbtn");
btn1.style.color="black";
btn1.style.backgroundColor="white"
...
function gotoshirts(){
    let btn=document.getElementById("shirtsbtn");
    btn.style.color="white";
    btn.style.backgroundColor="black"
    let btn1=document.getElementById("jeansbtn");
btn1.style.color="black";
btn1.style.backgroundColor="white";
let btn2=document.getElementById("tshirtsbtn");
btn2.style.color="black";
btn2.style.backgroundColor="white";
let btn3=document.getElementById("trousersbtn");
btn3.style.color="black";
btn3.style.backgroundColor="white";


    let jeans =document.getElementById("product_sec4");
    jeans.style.display="none";
    let tshirts =document.getElementById("product_sec5");
    tshirts.style.display="none";
    let trousers =document.getElementById("product_sec6");
    trousers.style.display="none";
    let shirts=document.getElementById("product_sec3");
    shirts.style.display="block";
}
function gotojeans(){
    let btn=document.getElementById("jeansbtn");
    btn.style.color="white";
    btn.style.backgroundColor="black"
    let btn1=document.getElementById("shirtsbtn");
btn1.style.color="black";
btn1.style.backgroundColor="white";
let btn2=document.getElementById("tshirtsbtn");
btn2.style.color="black";
...
function gototshirts(){
    let btn=document.getElementById("tshirtsbtn");
    btn.style.color="white";
    btn.style.backgroundColor="black"
    let btn1=document.getElementById("shirtsbtn");
btn1.style.color="black";
btn1.style.backgroundColor="white";
let btn2=document.getElementById("jeansbtn");
btn2.style.color="black";
btn2.style.backgroundColor="white";
let btn3=document.getElementById("trousersbtn");
btn3.style.color="black";
...
shirts.style.display="none";
    ...
    let btn=document.getElementById("trousersbtn");
    btn.style.color="white";
    btn.style.backgroundColor="black"
    let btn1=document.getElementById("shirtsbtn");
btn1.style.color="black";
...
btn2.style.color="black";
btn2.style.backgroundColor="white";
let btn3=document.getElementById("jeanssbtn");
btn3.style.color="black";
btn3.style.backgroundColor="white";
}
